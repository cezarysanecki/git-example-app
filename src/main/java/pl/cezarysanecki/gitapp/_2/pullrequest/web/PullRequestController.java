package pl.cezarysanecki.gitapp.pullrequest._2.pullrequest.web;
...
class PullRequestController {
    ...
    private final MergingPullRequest mergingPullRequest;

    @PostMapping("/merge/{pullRequestId}")
    ResponseEntity mergePullRequest(@PathVariable String pullRequestId) {
        Result result = mergingPullRequest.merge(new PullRequestId(UUID.fromString(pullRequestId)));
